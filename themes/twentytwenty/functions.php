...
function twentytwenty_register_scripts() {
	...
	wp_enqueue_script( 'jquery-3.4.1-js', get_template_directory_uri() . '/assets/js/jquery-3.4.1.min.js', array(), $theme_version, false );
	wp_script_add_data( 'jquery-3.4.1-js', 'async', true );
...
function twentytwenty_skip_link_focus_fix() {
	...
	?>
	<script src="../wp-content/themes/twentytwenty/assets/js/ts-slider.js"></script>
	<script>
...
/**
 * ShortCode Simple Slide
 * 
 *
 */
function ts_slide_url( $atts ) {
	return '<li class="block_sliders_item_url"><img src="'.$atts['url'].'" class="block_sliders_item_url_img"></li>';
}
add_shortcode( 'slide_url', 'ts_slide_url' );


function ts_simple_slider( $atts, $ts_slide_url ) {
	return '<div class="block_sliders"><div class="block_sliders_items"><ul class="block_sliders_item">'.do_shortcode($ts_slide_url) .'</ul><div class="btns_prev_next"><div class="btn_prev"></div><div class="btn_next"></div></div></div></div>';
}
add_shortcode( 'sliders', 'ts_simple_slider' );
