<?php
    ...
    // -> START Color Settings
        ...
        'id'    => 'Color',
        'desc'  => __( 'Color Settings Background.', 'redux-framework-demo' ),
        'icon'  => 'el el-brush'
    ) );

        Redux::setSection( $opt_name, array(
            'title'      => __( 'Color Settings Background', 'redux-framework-demo' ),
           ...
           'subsection' => true,
            'fields'     => array(
                array(
                    ...
                    'subtitle' => __( 'Body background with image, color, etc. (default: #ffffff).', 'redux-framework-demo' ),
                    'default'  => '#ffffff',
                ),
                array(
                    'id'       => 'opt-color-header',
                    ...
                    'subtitle' => __( 'Header background with image, color, etc. (default: #ffffff).', 'redux-framework-demo' ),
                    'default'  => '#ffffff',
                ),
                array(
                    'id'       => 'opt-color-footer',
                    ...
                    'subtitle' => __( 'Footer background with image, color, etc. (default: #ffffff).', 'redux-framework-demo' ),
                    'default'  => '#ffffff',
                ),
                 array(
                    'id'       => 'opt-color-text',
                    ...
                    'subtitle' => __( 'Body Text Color (default: #000000).', 'redux-framework-demo' ),
                    'default'  => '#000000',
                ),
            )
) );
